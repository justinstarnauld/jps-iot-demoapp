...
$(document).ready(() => {
    ...
    $('#searchButton').on('click', (event) => {
        ...
        if (searchDeviceInput.val() !== '') {
            // Make sure we're not already listening to some device
            this.dweetio.stop_listening();
            // Send device name to dweet.io or thingspace.io
                ...
                if (err) {
                    ...
                    <div class="card card-danger text-center z-depth-2">
                        <div class="card-block">
                            <h5 class="white-text">Uh oh! No device found with that name.</h5>
                            <h6 class="white-text">Please check spelling and try again. :)</h6>
                        </div>
                    </div>
                    `
